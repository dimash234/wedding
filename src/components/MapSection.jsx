...
export default function MapSection() {
  ...
  return (
    <section id="map" style={{ padding: '80px 20px', background: 'var(--cream)', position: 'relative' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          <KazakhOrnament type="divider" color="var(--gold)" />
          <p style={{ letterSpacing: '5px', fontSize: '11px', textTransform: 'uppercase', color: 'var(--gold)', marginBottom: '12px', marginTop: '32px' }}>
            {t.map.label}
          </p>
          <h2 style={{ fontSize: 'clamp(28px, 5vw, 48px)', fontWeight: 300, fontStyle: 'italic', color: 'var(--text-dark)', marginBottom: '12px' }}>
            {t.map.title}
          </h2>
        ...
        <div style={{ borderRadius: '8px', overflow: 'hidden', border: '1px solid var(--border)', boxShadow: '0 8px 40px rgba(201,168,76,0.12)' }}>
          ...
          <iframe
            ...
            title="Той өтетін орын" allowFullScreen
          />
        </div>
        ...
        <div style={{ marginTop: '24px', display: 'flex', flexWrap: 'wrap', gap: '16px', justifyContent: 'center' }}>
          <a href="https://2gis.kz/almaty/firm/70000001054095105/77.04876,43.305975" target="_blank" rel="noopener noreferrer"
            style={{
              ...
              padding: '14px 32px', background: 'linear-gradient(135deg, var(--gold), var(--gold-light))',
              color: 'white', textDecoration: 'none', borderRadius: '4px',
              fontFamily: "'Raleway', sans-serif", fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', fontWeight: 500,
              boxShadow: '0 4px 16px rgba(201,168,76,0.3)', transition: 'all 0.3s ease'
            }}
          ...
          <a href="https://maps.google.com/?q=43.305975,77.04876" target="_blank" rel="noopener noreferrer"
            style={{
              display: 'inline-flex', alignItems: 'center', gap: '10px',
              padding: '14px 32px', background: 'var(--white)', border: '1px solid var(--border)',
              color: 'var(--text-mid)', textDecoration: 'none', borderRadius: '4px',
              fontFamily: "'Raleway', sans-serif", fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', fontWeight: 500,
